...
?>
<script>
    window.location = "../project-1/Home1.php";
</script>
<?php
    }
...
<center>
    ...
    <body style="background-color: rgba(137, 140, 140, 0.586);">
        ...
        <form style="background-color: rgba(137, 140, 140, 0.586); width:30%;height:40vh;margin-top:5%;"
            onSubmit="return(validate123());" method="post" enctype="multipart/form-data" action="">
            <h3><u>Forget Password</u></h3>

            <div>
                <!-- <label for="email">Email address:</label> -->
                <input type="text" class="box" placeholder="Enter Email" id="em" name="mail"
                    onblur="demo(this)">
                <p id="mail1"></p>
            </div>
            ...
            {{-- <div>
                ...
                <input type="password" class="box" placeholder="Enter Password" id="pwd" name="pass">
                <p id="passw"></p>
            </div> --}}

            <input type="submit" class="delete-btnn" style="color:fff"value="Submit" name="login" /><br>
