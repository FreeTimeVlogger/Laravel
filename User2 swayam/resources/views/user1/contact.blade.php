    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <form action="contact_insert" method="post" class="php-email-form">
              @csrf
              <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Terms and conditions. Read our privacy policy. We never spam, emails will only be sent weekly.</p>
          </div>
          <div class="col-lg-6">
