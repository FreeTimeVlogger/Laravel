      ...
      <div class="card " id="highlights">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card">
            <img  src="{{ $programs->image }}" class="card-img-top" alt="news_1">
              <div class="card-body">
                <h5 class="card-title fw-bold">"{{ $programs->topic }}"</h5>
                <p class="card-text text-secondary" id="key1" style="text-align: justify;">"{{ $programs->text }}</p>
