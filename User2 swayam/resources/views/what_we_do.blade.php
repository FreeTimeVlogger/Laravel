...
<body>
    ...
    </header><!-- End Header -->    <div style="background-color:azure">
        <div class=" text-center">
            @if ($what_we_do != null)
                @foreach ($what_we_do as $what_we_do)
                    <center><img src="{{ $what_we_do->image }}" alt="service" width="70%"></center>
        </div><br><br>
        <div class="container-fluid text-center" style="background-color: lightyellow;">
            

        </div>
        <div class="container-fluid text-justify" style="font-size:x-large" id="education">
           <center> <h1>"{{ $what_we_do->topic }}"</center></h1><br>
            <p>"{{ $what_we_do->text }}" </p>
            <br>
        </div>
    </div>
