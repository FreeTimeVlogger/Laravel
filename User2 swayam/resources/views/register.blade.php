...
<body style="justify-content: center;border: #ffffff solid 2px;">
    ...
    <section class="nav">
        <nav>
            ...
            <div style="font-size: 20px;"><a href="After_home"><button class="home">Home</button></a></div>
        </nav>
        ...
        <div style="display: flex;justify-content: center;margin-top: -70px;">
            <div
                ...
                <form onSubmit="return(validate123());" method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="form-group ab">
                        ...
                        <input type="email" class="form-control" placeholder="Enter Email" id="emailid1"
                            name="em" onblur="check_email(this)">
                        <p id="mail1"></p>
                    </div>
                ...
                <center><button
                        ...
                        <a href="./login.php" style="color:#fff;"><b>Log in</b></a></button></center><br>
            </div>
        </div>
        </div>
    </section>
